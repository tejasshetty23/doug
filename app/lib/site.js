...
export const bonuses = [
  ...
  },
  {
    ...
    blurb: "Every Stake.com wager under code ratmode counts automatically. Top 5 get paid every month.",
    perks: ["Auto-tracked, no sign-up form", `Race ends ${raceEndLabel()}`, "Prizes down to 5th place"],
    code: "ratmode",
